<?php 
    $slide_image = get_field('vsz_slide_about_company_image',11);
?>        
    ...
    <div class="index-page-slider-info">
        <div class="container index-page-slider-info__wrapper">
            ...
            <div class="index-page-slider-info__description">
                <?php echo get_field('vsz_slide_about_company_description',11);?>
            </div>
            <div class="index-page-slider-info__buttons">
                <a href="about" class="index-page-slider-info__button">о компании</a>
                <a href="history" class="index-page-slider-info__button">история</a>
                <a href="advantages" class="index-page-slider-info__button">наши преимущества</a>
            </div>
        </div>
    </div>
