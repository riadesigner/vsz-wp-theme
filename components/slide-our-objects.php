        <div id="our-objects-slide" class="slider__item">
            ...
            <div class="index-page-slider__picture">
                <div class="index-page-slider-image index-page-slider__small-image"
                     style="--background: url('../../assets/images/img-4.jpg')"></div>
                <div class="index-page-slider-image index-page-slider__delimiter" style="--background: url('../../assets/images/img-4.jpg')"></div>
